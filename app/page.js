        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={4}>
            ...
            <Typography>
              ...
              flashcards has never been easier when you use our AI service!!!
            </Typography>
          </Grid>
          <Grid item xs={12} md={4}>
            ...
            <Typography>
              {" "}
              Our AI breaksdown your text into concise flashcards perfect for
              studying!
            </Typography>
          </Grid>
          <Grid item xs={12} md={4}>
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <Typography>
                {" "}
                Access to our basic pricing for flashcard features, this plan
                has limited storage!
              </Typography>
              <Button variant="contained" color="primary" sx={{ mt: 2 }}>
                Choose Basic Plan
